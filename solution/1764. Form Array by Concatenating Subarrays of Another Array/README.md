...
<div class="xFUwe" data-track-load="description_content"><p>You are given a 2D integer array <code>groups</code> of length <code>n</code>. You are also given an integer array <code>nums</code>.</p>
