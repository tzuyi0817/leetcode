...
<div class="elfjS" data-track-load="description_content"><p>You are given an array of binary strings <code>strs</code> and two integers <code>m</code> and <code>n</code>.</p>
...
- Time complexity: <em>O(strs.length\*mn)</em>
