...
<div class="elfjS" data-track-load="description_content"><p>Given an <code>m x n</code> grid. Each cell of the grid has a sign pointing to the next cell you should visit if you are currently in this cell. The sign of <code>grid[i][j]</code> can be:</p>
...
- Time complexity: <em>O(mn\*log(mn))</em>
