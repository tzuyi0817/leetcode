...
<div class="elfjS" data-track-load="description_content"><p>The <strong>score</strong> of an array is defined as the <strong>product</strong> of its sum and its length.</p>
