...
<div class="elfjS" data-track-load="description_content"><p>We have <code>n</code> buildings numbered from <code>0</code> to <code>n - 1</code>. Each building has a number of employees. It's transfer season, and some employees want to change the building they reside in.</p>
...
- Time complexity: <em>O(n\*2<sup>requests.length</sup>)</em>
- Space complexity: <em>O(n + requests.length)</em>
