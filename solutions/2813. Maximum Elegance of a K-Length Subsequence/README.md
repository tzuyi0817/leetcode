...
<div class="HTMLContent_html__0OZLp" data-track-load="description_content"><p>You are given a <strong>0-indexed</strong> 2D integer array <code>items</code> of length <code>n</code> and an integer <code>k</code>.</p>
...
<pre><strong>Input:</strong> items = [[3,2],[5,1],[10,1]], k = 2
...
<pre><strong>Input:</strong> items = [[3,1],[3,1],[2,2],[5,3]], k = 3
...
<pre><strong>Input:</strong> items = [[1,1],[2,1],[3,1]], k = 3
