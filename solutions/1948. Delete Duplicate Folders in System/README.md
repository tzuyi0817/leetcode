...
<div class="elfjS" data-track-load="description_content"><p>Due to a bug, there are many duplicate folders in a file system. You are given a 2D array <code>paths</code>, where <code>paths[i]</code> is an array representing an absolute path to the <code>i<sup>th</sup></code> folder in the file system.</p>
...
- Time complexity: <em>O(n\*hlogh)</em>
- Space complexity: <em>O(n\*h)</em>
