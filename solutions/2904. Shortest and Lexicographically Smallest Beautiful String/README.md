...
<div class="HTMLContent_html__0OZLp" data-qd-rendered-description="" data-track-load="description_content"><p>You are given a binary string <code>s</code> and a positive integer <code>k</code>.</p>
