...
<div class="elfjS" data-track-load="description_content"><p>You are given two integers <code>memory1</code> and <code>memory2</code> representing the available memory in bits on two memory sticks. There is currently a faulty program running that consumes an increasing amount of memory every second.</p>
...
- Time complexity: <em>O(log(memory1+memory2))</em>
