...
<div class="elfjS" data-track-load="description_content"><p>There is an undirected weighted graph with <code>n</code> vertices labeled from <code>0</code> to <code>n - 1</code>.</p>
...
- Time complexity: <em>O(edges.length\*logn+query.length)</em>
