...
<div class="HTMLContent_html__0OZLp" data-track-load="description_content"><p>You are given two arrays of strings <code>wordsContainer</code> and <code>wordsQuery</code>.</p>
...
- Time complexity: <em>O(m+n)</em>
  - `m` is sum of `wordsContainer[i].length`
  - `n` is sum of `wordsQuery[i].length`
