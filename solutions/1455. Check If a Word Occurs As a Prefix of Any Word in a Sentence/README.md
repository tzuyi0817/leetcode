...
<div class="elfjS" data-track-load="description_content"><p>Given a <code>sentence</code> that consists of some words separated by a <strong>single space</strong>, and a <code>searchWord</code>, check if <code>searchWord</code> is a prefix of any word in <code>sentence</code>.</p>
...
- Time complexity: <em>O(L+W⋅min(s,l))</em>
- Space complexity: <em>O(L)</em>
