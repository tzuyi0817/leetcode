...
<div class="elfjS" data-track-load="description_content"><p>You are given an <code>m x n</code> integer matrix <code>grid</code> and an integer <code>k</code>.</p>
...
- Time complexity: <em>O((m-k)\*(n-k)\*k<sup>2</sup>)</em>
- Space complexity: <em>O((m-k)\*(n-k))</em>
