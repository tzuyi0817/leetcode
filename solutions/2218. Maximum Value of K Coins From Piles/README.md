...
<div class="elfjS" data-track-load="description_content"><p>There are <code>n</code> <strong>piles</strong> of coins on a table. Each pile consists of a <strong>positive number</strong> of coins of assorted denominations.</p>
...
- Time complexity: <em>O(nk\*piles[i].length)</em>
