...
<div class="elfjS" data-track-load="description_content"><p>You are given a list of strings of the <strong>same length</strong> <code>words</code> and a string <code>target</code>.</p>
...
- Time complexity: <em>O(words.length\*m+mn)</em>
