...
<div class="elfjS" data-track-load="description_content"><p>You are given a <strong>0-indexed binary</strong> string <code>floor</code>, which represents the colors of tiles on a floor:</p>
...
- Time complexity: <em>O(n\*numCarpets)</em>
- Space complexity: <em>O(n\*numCarpets)</em>
